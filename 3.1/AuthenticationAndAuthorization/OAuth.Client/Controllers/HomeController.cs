...
namespace OAuth.Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var serverResponse = await AccessTokenRefreshWraper(
                () => SecuredGetRequest("https://localhost:44310/secret/index"));

            var apiResponse = await AccessTokenRefreshWraper(
        ...
        private async Task<HttpResponseMessage> AccessTokenRefreshWraper(
        ...
        private async Task RefreshAccessToken()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:44310/OAuth/Token")
            {
